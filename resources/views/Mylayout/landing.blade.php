            ...
            <div class="row pt-5">
                <div class="col-md-8 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <h1 class="display-4 fw-bold mb-5">rendez-vous chez votre &nbsp;<span
    ...
    <section class="mt-5 py-xl-5" id="apropos">
        <div class="col-12 col-lg-10 d-flex align-items-center justify-content-space-between mt-3">
            ...
            <p class="">Bienvenue sur le site du cabinet médical du Docteur Rouchdi, votre médecin généraliste .
                Notre équipe médicale est là pour vous fournir les meilleurs soins de santé possibles et vous
                accompagner tout au long de votre parcours médical.
                <br> Nous sommes convaincus que la santé est la clé du bien-être .
                <br> N&apos;hésitez pas à nous contacter pour prendre rendez-vous ou pour toute question concernant nos
                services.
            </p>
        </div>
    </section>
