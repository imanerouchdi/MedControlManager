...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/styleReserve.css') }}" />
...
<body>
    ...
    <div class="container   mt-5 ">
        ...
        <div class=" card p-1 mb-5 align-items-center mt-5">
            <div class="card-body ">
                <h3 class="card-title text-center   mt-5 mb-4">Planifier un rendez-vous </h3>
                <form id="formappointmentUser" class="mx-5 my-5 w-auto" action="{{ route('appointmentUser.store') }}"
                    method="POST">
                    @csrf
                    @method('POST')
                    <div class="row mb-1 ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if ($paginator->previousPageUrl())
                                <a href="{{ $paginator->previousPageUrl() }}"class="btn btn-primary  bg-info float-left"id="prev-date-btn">
                                    <i class="fa-solid fa-backward"></i>
                                </a>
                            @endif
                            @if ($paginator->nextPageUrl())
                                <a href="{{ $paginator->nextPageUrl() }}" class="btn btn-primary bg-info py-2 mb-3 float-right" id="next-date-btn">
